 ...
 * It includes codes for successful requests, redirection, client errors, and server errors.
 * Each status code is a three-digit number, and the first digit of the status code defines the class of response.
